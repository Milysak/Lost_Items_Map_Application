 ...
 * Use the [RegisterStepTwoFragment.newInstance] factory method to
...
class RegisterStepTwoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.backButton).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_registerStepTwoFragment_to_registerStepOneFragment)
        }
    }
